...
class MySKills extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const Column(
      ...
      children: [
        AnimatedLinearProgressIndicator(percentage: 0.75, title: 'Flutter',image: 'assets/icons/flutter.png',),
        AnimatedLinearProgressIndicator(percentage: 0.8, title: 'Dart',image: 'assets/icons/dart.png'),
        ...
        AnimatedLinearProgressIndicator(percentage: 0.8, title: 'Bloc',image: 'assets/icons/bloc.png'),
      ],);
  }
}
